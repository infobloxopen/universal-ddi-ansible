...
DOCUMENTATION = r"""
---
module: dtc_health_check_sip_info
short_description: Retrieves DTC SIP Health Checks
description:
    - Retrieve information about DTC SIP Health Checks
version_added: 1.0.0
...
EXAMPLES = r"""
    - name: Get SIP Health Check information by filters (name)
      infoblox.universal_ddi.dtc_health_check_sip_info:
        filters:
          name: "example_sip_health_check"
    
    - name: Get SIP Health Check information by filters (id)
      infoblox.universal_ddi.dtc_health_check_sip_info:
        filters:
          id: "{{  health_check_sip.id  }}"
    
    - name: Get SIP Health Check information by filter query
      infoblox.universal_ddi.dtc_health_check_sip_info:
        filter_query: "name=='example_sip_health_check'"
    
    - name: Get SIP Health Check information by tag filters
      infoblox.universal_ddi.dtc_health_check_sip_info:
        tag_filters:
          location: "site-1"
"""  # noqa: E501
...
try:
    from dtc import HealthCheckSipApi
    from universal_ddi_client import ApiException, NotFoundException
except ImportError:
    pass  # Handled by UniversalDDIAnsibleModule


class HealthCheckSipInfoModule(UniversalDDIAnsibleModule):
    def __init__(self, *args, **kwargs):
        super(HealthCheckSipInfoModule, self).__init__(*args, **kwargs)
        self._existing = None
        self._limit = 1000
    ...
    def find(self):
        ...
        while True:
            try:
                resp = HealthCheckSipApi(self.client).list(
...
def main():
    ...
    module = HealthCheckSipInfoModule(
