...
try:
    from dtc import HealthCheckIcmpApi
    from universal_ddi_client import ApiException, NotFoundException
except ImportError:
    pass  # Handled by UniversalDDIAnsibleModule


class HealthCheckIcmpInfoModule(UniversalDDIAnsibleModule):
    def __init__(self, *args, **kwargs):
        super(HealthCheckIcmpInfoModule, self).__init__(*args, **kwargs)
        self._existing = None
        self._limit = 1000
    ...
    def find(self):
        ...
        while True:
            try:
                resp = HealthCheckIcmpApi(self.client).list(
...
def main():
    ...
    module = HealthCheckIcmpInfoModule(
